...
program postprocess_fluid_stats
  ...
  call reynolds%set_to_field(1, pp)
  call reynolds%set_to_field(2, uu)
  call reynolds%set_to_field(3, vv)
  call reynolds%set_to_field(4, ww)
  call reynolds%set_to_field(5, uv)
  call reynolds%set_to_field(6, uw)
  call reynolds%set_to_field(7, vw)
  ...
  call mean_vel_grad%set_to_field(1, pp)
  call mean_vel_grad%set_to_field(2, uu)
  call mean_vel_grad%set_to_field(3, vv)
  call mean_vel_grad%set_to_field(4, ww)
  call mean_vel_grad%set_to_field(5, uv)
  call mean_vel_grad%set_to_field(6, uw)
  call mean_vel_grad%set_to_field(7, vw)
  call mean_vel_grad%set_to_field(8, tmp1)
  call mean_vel_grad%set_to_field(9, tmp2)

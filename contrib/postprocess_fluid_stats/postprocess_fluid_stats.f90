...
program postprocess_fluid_stats
  ...
  call reynolds%set(1, pp)
  call reynolds%set(2, uu)
  call reynolds%set(3, vv)
  call reynolds%set(4, ww)
  call reynolds%set(5, uv)
  call reynolds%set(6, uw)
  call reynolds%set(7, vw)
  ...
  call mean_vel_grad%set(1, pp)
  call mean_vel_grad%set(2, uu)
  call mean_vel_grad%set(3, vv)
  call mean_vel_grad%set(4, ww)
  call mean_vel_grad%set(5, uv)
  call mean_vel_grad%set(6, uw)
  call mean_vel_grad%set(7, vw)
  call mean_vel_grad%set(8, tmp1)
  call mean_vel_grad%set(9, tmp2)

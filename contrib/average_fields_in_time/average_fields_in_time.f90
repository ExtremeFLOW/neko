...
contains
  ...
  !! of the very first sample. In other words the time at which the statistics
  !! start to be sampled.
  !! NOTE: The format of the csv file is:
  !!       time_0, x1, field1, field2, ...
  !!       time_0, x2, field1, field2, ...
  !!       ...
  !!       time_0, xN, field1, field2, ...
  !!       time_1, x1, field1, field2, ...
  !!       time_1, x2, field1, field2, ...
  !!       ...
  !!       time_1, xN, field1, field2, ...
  !!       etc...

...
module opr_sx
  use sx_dudxyz, only : sx_dudxyz_lx14, sx_dudxyz_lx13, sx_dudxyz_lx12, &
      sx_dudxyz_lx11, sx_dudxyz_lx10, sx_dudxyz_lx9, sx_dudxyz_lx8, &
      sx_dudxyz_lx7, sx_dudxyz_lx6, sx_dudxyz_lx5, sx_dudxyz_lx4, &
      sx_dudxyz_lx3, sx_dudxyz_lx2, sx_dudxyz_lx
  use sx_opgrad, only : sx_opgrad_lx18, sx_opgrad_lx17, sx_opgrad_lx16, &
      sx_opgrad_lx15, sx_opgrad_lx14, sx_opgrad_lx13, sx_opgrad_lx12, &
      sx_opgrad_lx11, sx_opgrad_lx10, sx_opgrad_lx9, sx_opgrad_lx8, &
      sx_opgrad_lx7, sx_opgrad_lx6, sx_opgrad_lx5, sx_opgrad_lx4, &
      sx_opgrad_lx3, sx_opgrad_lx2, sx_opgrad_lx
  use sx_conv1, only : sx_conv1_lx14, sx_conv1_lx13, sx_conv1_lx12, &
      sx_conv1_lx11, sx_conv1_lx10, sx_conv1_lx9, sx_conv1_lx8, sx_conv1_lx7, &
      sx_conv1_lx6, sx_conv1_lx5, sx_conv1_lx4, sx_conv1_lx3, sx_conv1_lx2, &
      sx_conv1_lx
  use sx_cdtp, only : sx_cdtp_lx14, sx_cdtp_lx13, sx_cdtp_lx12, sx_cdtp_lx11, &
      sx_cdtp_lx10, sx_cdtp_lx9, sx_cdtp_lx8, sx_cdtp_lx7, sx_cdtp_lx6, &
      sx_cdtp_lx5, sx_cdtp_lx4, sx_cdtp_lx3, sx_cdtp_lx2, sx_cdtp_lx
  use sx_cfl, only : sx_cfl_lx14, sx_cfl_lx13, sx_cfl_lx12, sx_cfl_lx11, &
      sx_cfl_lx10, sx_cfl_lx9, sx_cfl_lx8, sx_cfl_lx7, sx_cfl_lx6, &
      sx_cfl_lx5, sx_cfl_lx4, sx_cfl_lx3, sx_cfl_lx2, sx_cfl_lx
  use sx_lambda2, only : sx_lambda2_lx18, sx_lambda2_lx17, sx_lambda2_lx16, &
      sx_lambda2_lx15, sx_lambda2_lx14, sx_lambda2_lx13, sx_lambda2_lx12, &
      sx_lambda2_lx11, sx_lambda2_lx10, sx_lambda2_lx9, sx_lambda2_lx8, &
      sx_lambda2_lx7, sx_lambda2_lx6, sx_lambda2_lx5, sx_lambda2_lx4, &
      sx_lambda2_lx3, sx_lambda2_lx2, sx_lambda2_lx
  use sx_convect_scalar, only : sx_convect_scalar_lx18, &
      sx_convect_scalar_lx17, sx_convect_scalar_lx16, sx_convect_scalar_lx15, &
      sx_convect_scalar_lx14, sx_convect_scalar_lx13, sx_convect_scalar_lx12, &
      sx_convect_scalar_lx11, sx_convect_scalar_lx10, sx_convect_scalar_lx9, &
      sx_convect_scalar_lx8, sx_convect_scalar_lx7, sx_convect_scalar_lx6, &
      sx_convect_scalar_lx5, sx_convect_scalar_lx4, sx_convect_scalar_lx3, &
      sx_convect_scalar_lx2, sx_convect_scalar_lx
  use sx_set_convect_rst, only : sx_set_convect_rst_lx18, &
      sx_set_convect_rst_lx17, sx_set_convect_rst_lx16, &
      sx_set_convect_rst_lx15, sx_set_convect_rst_lx14, &
      sx_set_convect_rst_lx13, sx_set_convect_rst_lx12, &
      sx_set_convect_rst_lx11, sx_set_convect_rst_lx10, &
      sx_set_convect_rst_lx9, sx_set_convect_rst_lx8, sx_set_convect_rst_lx7, &
      sx_set_convect_rst_lx6, sx_set_convect_rst_lx5, sx_set_convect_rst_lx4, &
      sx_set_convect_rst_lx3, sx_set_convect_rst_lx2, sx_set_convect_rst_lx
  use gather_scatter, only : gs_t, GS_OP_ADD
  use interpolation, only : interpolator_t
  use num_types, only : rp
  use space, only : space_t
  use coefs, only : coef_t
  use math, only :copy, rzero, sub3
...
contains
  ...
  subroutine opr_sx_convect_scalar(du, u, c, Xh_GLL, Xh_GL, coef_GLL, &
                                   coef_GL, GLL_to_GL)
  ...
  subroutine opr_sx_set_convect_rst(cr, cs, ct, cx, cy, cz, Xh, coef)
    type(space_t), intent(inout) :: Xh
    type(coef_t), intent(inout) :: coef

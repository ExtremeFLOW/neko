...
#ifdef HAVE_HIP
  interface
     subroutine hip_richardson_compute(u_d, v_d, w_d, temp_d, temp_w_d, &
...
#elif HAVE_CUDA
  interface
     subroutine cuda_richardson_compute(u_d, v_d, w_d, temp_d, temp_w_d, &
          n_x_d, n_y_d, n_z_d, h_d, &
          tau_x_d, tau_y_d, tau_z_d, n_nodes, &
          kappa, mu_w_d, rho_w_d, g, Pr, z0, z0h_in, bc_type_int, &
          bc_value, tstep, &
...
contains
  ...
  subroutine richardson_compute_device(u_d, v_d, w_d, temp_d, temp_w_d, &
...
#if HAVE_HIP
    call hip_richardson_compute(u_d, v_d, w_d, temp_d, temp_w_d, &
         n_x_d, n_y_d, n_z_d, h_d, &
         tau_x_d, tau_y_d, tau_z_d, n_nodes, &
         ...
         ts_diagn, q_diagn)
#elif HAVE_CUDA
    call cuda_richardson_compute(u_d, v_d, w_d, temp_d, temp_w_d, &
         n_x_d, n_y_d, n_z_d, h_d, &
         tau_x_d, tau_y_d, tau_z_d, n_nodes, &
         kappa, mu_w_d, rho_w_d, g, Pr, z0, z0h_in, &
         bc_type_int, bc_value, tstep, Ri_b_diagn, &
  ...
  end subroutine richardson_compute_device
end module richardson_device

...
#ifdef HAVE_HIP
  interface
     subroutine hip_most_compute(u_d, v_d, w_d, temp_d, temp_w_d, &
...
#elif HAVE_CUDA
  interface
     subroutine cuda_most_compute(u_d, v_d, w_d, temp_d, temp_w_d, &
          n_x_d, n_y_d, n_z_d, h_d, &
          tau_x_d, tau_y_d, tau_z_d, n_nodes, &
          kappa, mu_w_d, rho_w_d, g, Pr, z0, z0h_in, bc_type_int, &
          bc_value, tstep, &
...
#elif HAVE_OPENCL
  interface
     subroutine opencl_most_compute(u_d, v_d, w_d, temp_d, temp_w_d, &
          n_x_d, n_y_d, n_z_d, h_d, &
          tau_x_d, tau_y_d, tau_z_d, n_nodes, &
          kappa, mu_w_d, rho_w_d, g, Pr, z0, z0h_in, bc_type_int, &
          bc_value, tstep, &
          Ri_b_diagn, L_ob_diagn, utau_diagn, magu_diagn, ti_diagn, &
          ts_diagn, q_diagn) &
          bind(c, name = 'opencl_most_compute')
       use, intrinsic :: iso_c_binding, only : c_ptr, c_int
       use num_types, only : c_rp
       implicit none
       type(c_ptr), value :: u_d, v_d, w_d, temp_d, temp_w_d
       ...
       type(c_ptr), value :: utau_diagn, magu_diagn
       type(c_ptr), value :: ti_diagn, ts_diagn, q_diagn
     end subroutine opencl_most_compute
  end interface
#elif HAVE_METAL
  interface
     subroutine metal_most_compute(u_d, v_d, w_d, temp_d, temp_w_d, &
          n_x_d, n_y_d, n_z_d, h_d, &
          tau_x_d, tau_y_d, tau_z_d, n_nodes, &
          kappa, mu_w_d, rho_w_d, g, Pr, z0, z0h_in, bc_type_int, &
          bc_value, tstep, &
          Ri_b_diagn, L_ob_diagn, utau_diagn, magu_diagn, ti_diagn, &
          ts_diagn, q_diagn) &
          bind(c, name = 'metal_most_compute')
       use, intrinsic :: iso_c_binding, only : c_ptr, c_int
       use num_types, only : c_rp
       implicit none
       type(c_ptr), value :: u_d, v_d, w_d, temp_d, temp_w_d
       ...
       type(c_ptr), value :: utau_diagn, magu_diagn
       type(c_ptr), value :: ti_diagn, ts_diagn, q_diagn
     end subroutine metal_most_compute
  end interface
#endif
...
#if HAVE_HIP
    call hip_most_compute(u_d, v_d, w_d, temp_d, temp_w_d, &
         n_x_d, n_y_d, n_z_d, h_d, &
         tau_x_d, tau_y_d, tau_z_d, n_nodes, &
         ...
         ts_diagn, q_diagn)
#elif HAVE_CUDA
    call cuda_most_compute(u_d, v_d, w_d, temp_d, temp_w_d, &
         n_x_d, n_y_d, n_z_d, h_d, &
         tau_x_d, tau_y_d, tau_z_d, n_nodes, &
         kappa, mu_w_d, rho_w_d, g, Pr, z0, z0h_in, &
         bc_type_int, bc_value, tstep, Ri_b_diagn, &
         ...
         ts_diagn, q_diagn)
#elif HAVE_OPENCL
    call opencl_most_compute(u_d, v_d, w_d, temp_d, temp_w_d, &
         n_x_d, n_y_d, n_z_d, h_d, &
         tau_x_d, tau_y_d, tau_z_d, n_nodes, &
         kappa, mu_w_d, rho_w_d, g, Pr, z0, z0h_in, &
         bc_type_int, bc_value, tstep, Ri_b_diagn, &
         ...
         ts_diagn, q_diagn)
#elif HAVE_METAL
    call metal_most_compute(u_d, v_d, w_d, temp_d, temp_w_d, &
         n_x_d, n_y_d, n_z_d, h_d, &
         tau_x_d, tau_y_d, tau_z_d, n_nodes, &
         kappa, mu_w_d, rho_w_d, g, Pr, z0, z0h_in, &
         bc_type_int, bc_value, tstep, Ri_b_diagn, &

module rhs_maker_cpu
  ...
  type, public, extends(rhs_maker_sumab_t) :: rhs_maker_sumab_cpu_t
   contains
     ...
     procedure, nopass :: compute_scalar => scalar_rhs_maker_sumab_cpu
...
contains
  ...
  subroutine scalar_rhs_maker_sumab_cpu(s, ss, sslag, ab, nab)
  ...
  end subroutine scalar_rhs_maker_sumab_cpu
  ...
  subroutine scalar_rhs_maker_ext_cpu(temp, fs_lag, fs_laglag, fs, rho, ext_coeffs, &
                                n)
  ...
  subroutine scalar_rhs_maker_bdf_cpu(ta1, tb1, slag, bfs, s, B, rho, dt, bd, nbd, n)    
    integer, intent(in) :: n, nbd

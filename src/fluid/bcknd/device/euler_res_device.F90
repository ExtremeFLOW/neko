...
contains
  subroutine advance_primitive_variables_device(rho_field, m_x, m_y, m_z, E, p, u, v, w, Ax, &
  ...
  subroutine evaluate_rhs_device(rhs_rho_field, rhs_m_x, rhs_m_y, rhs_m_z, rhs_E, &

module rhs_maker_sx
  ...
  type, public, extends(fluid_sumab_t) :: fluid_sumab_sx_t
   contains
     procedure, nopass :: compute_fluid => fluid_sumab_sx
  end type fluid_sumab_sx_t

  type, public, extends(fluid_makeabf_t) ::  fluid_makeabf_sx_t
   contains
     procedure, nopass :: compute_fluid => fluid_makeabf_sx
  end type fluid_makeabf_sx_t

  type, public, extends(fluid_makebdf_t) :: fluid_makebdf_sx_t
   contains
     procedure, nopass :: compute_fluid => fluid_makebdf_sx
  end type fluid_makebdf_sx_t
  
contains

  subroutine fluid_sumab_sx(u, v, w, uu, vv, ww, uulag, vvlag, wwlag, ab, nab)
  ...
  end subroutine fluid_sumab_sx

  subroutine fluid_makeabf_sx(temp1, temp2, temp3, fx_lag, fy_lag, fz_lag, &
  ...
  end subroutine fluid_makeabf_sx

  subroutine fluid_makebdf_sx(ta1, ta2, ta3, tb1, tb2, tb3, &

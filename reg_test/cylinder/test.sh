...
awk 'c&&c--{if(c !=17 && $0 !~ /--/){print}};/100.00%/{c=19}' log1 > l1
awk 'c&&c--{if(c !=17 && $0 !~ /--/){print}};/100.00%/{c=19}' log2 > l2
awk 'c&&c--{if(c !=17 && $0 !~ /--/){print}};/100.00%/{c=19}' ref2.log > r2
awk 'c&&c--{if(c !=17 && $0 !~ /--/){print}};/100.00%/{c=19}' ref1.log > r1
diff l1 r1 > res
diff l2 r1 >> res
diff l1 r2 >> res
diff l2 r2 >> res

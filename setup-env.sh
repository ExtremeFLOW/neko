#!/bin/bash
# Environment setup for neko-multiphase-spurious-currents
#
# Usage:
...
if [ "$1" = "--local" ]; then
    ...
    export NEKO_SPURIOUS_PREFIX="$HOME/local/neko-spurious"
    ...
    echo "neko-spurious environment loaded (local/macOS)"
    ...
    echo "neko-spurious environment loaded (cluster/Dardel)"

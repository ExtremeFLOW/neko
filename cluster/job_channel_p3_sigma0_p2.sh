...
#SBATCH -t 08:00:00
#SBATCH -N 2
#SBATCH -J channel_p3_sigma0_p2
#SBATCH -p main
#SBATCH -o /cfs/klemming/projects/supr/kthmech/eriksie/logs/%J_channel_p3_sigma0_p2.log

# L2 (Phase 3) two-phase channel: σ=0 CDI diagnostic, 144×24×48 mesh, t=20→25
# _p2 variant: extra GS pass on n̂ before div(n) (element-face smoothing fix)
#
# ε=0.04, Δxz=0.0873, 4ε/Δ=1.83, ε/Δ_GLL=3.2 (constant ratio ε/Δxz=0.45)
# Purpose: compare κ_rms vs standard (job_channel_p3_sigma0.sh) to test whether
# the extra GS pass reduces the C0 kink artifact at element faces.
#
# Prerequisites:
#   1. neko_two_phase_p2 built: sbatch build_neko_two_phase_p2.sh
#   2. channel_p3_single_phase spin-up completed (fluid00004.chkp at t=20)
#
# Submit from Dardel login node:
#   sbatch $KTHMECH_PROJECT/scripts/job_channel_p3_sigma0_p2.sh

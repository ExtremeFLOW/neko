...
contain and how to use them: field::field_t, bc::bc_t, coefs::coef_t.
...
@note You can add your own fields to the registry with `neko_field_registry%%add_field` (see field_registry::add_field).

...
The simulation is performed at an LES resolution using Deardorff's model [1], which solves a scalar equation for turbulent kinetic energy to formulate the eddy viscosity.

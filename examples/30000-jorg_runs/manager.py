...
for i in range(0,number_of_cases):
    ...
    if cont=="yes":
        ...
        if ind_limit == -1000:
            ...
            for line in range(0,10000):
                ...
                if "dt" in inverted_log[indd]:
                    ...
                    string=inverted_log[indd]
                    dt_index=string.rfind("dt")
                    dt_joblimit = float(inverted_log[indd][dt_index+3:-1])
        ...
        if ind_chkp == -1000:
            ...
            for line in range(0,10):
                ...
                if "dt" in inverted_log[indd]:
                    ...
                    string=inverted_log[indd]
                    dt_index=string.rfind("dt")
                    dt_chkp = float(inverted_log[indd][dt_index+3:-1])
        ...
        if cont=="yes":
            ...
            params_file["case"]["end_time"] = 1500
            params_file["case"]["job_timelimit"] = "23:30:00"
            params_file["case"]["restart_file"] = chkp_file
            
            params_file["case"]["max_timestep"] = 2e-3

            min_cfl = 0.1
            current_cfl = params_file["case"]["constant_cfl"] 
            if current_cfl < min_cfl:
                params_file["case"]["constant_cfl"] = min_cfl

...
# Zalesak disk multiphase test case
# ============================================

# Directory containing simulation data
DATA_DIR="/cfs/klemming/scratch/e/eriksie/zalesak_param_analysis_data"

# Output directory for plots
OUTPUT_DIR="/cfs/klemming/projects/supr/kthmech/eriksie/data/zalesak_reference_plots"

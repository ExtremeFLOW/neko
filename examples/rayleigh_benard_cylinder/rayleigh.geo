...
compressRatio_B=1;  //ratio of grid compression toward the wall (<1)
compressRatio_M=1;  //compression ratio in the middle layer
Nz=30;    //no of elements in z-dire (axial)
///////////////////////////////////////////////////

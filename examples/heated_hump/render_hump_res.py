...
# outlet-region zoom at the latest frame (t past the old t=78.6 blow-up).
...
comm = MPI.COMM_WORLD
RUN = '../heated_hump_res/old_53K_run/'
...
fig.suptitle(f'Heated hump, Dong outflow — {ttl}  (past the old t=78.6 blow-up)', fontsize=13)

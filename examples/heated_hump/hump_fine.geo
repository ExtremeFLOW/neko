...
NxA = 40;   // upstream  [0,  x1]  (graded, dense toward the hump)
NxB = 140;   // hump      [x1, x2]  (FINE, captures the curvature)
NxC = 170;   // downstream[x2, Lx]  (graded, dense just after the hump)
Ny  = 48;   // wall-normal
Nz  = 60;   // spanwise
rGrow = 1.08;   // wall-normal growth -> fine cells at the lower wall
pA    = 0.90;   // upstream  streamwise progression (<1: dense toward x1)
pC    = 1.045;  // downstream streamwise progression (>1: dense after x2)

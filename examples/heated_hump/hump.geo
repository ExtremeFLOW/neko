...
NxB = 44;   // hump      [x1, x2]  (FINE, captures the curvature)
NxC = 52;   // downstream[x2, Lx]  (graded, dense just after the hump)
Ny  = 24;   // wall-normal
Nz  = 20;   // spanwise
rGrow = 1.12;   // wall-normal growth -> fine cells at the lower wall

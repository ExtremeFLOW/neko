...
//***** Grid Paramaters
Nc=5;  // no. of nodes (=#elem+1) in azimuthal direction
NB=1;   // no. of elemtns adjacent to the wall
NM=1;   // no. of nodes (=#elem+1) between the near wall layer and central square part
// compression ratios over the radial lines of the mesh
compressRatio_B=0.00;  //ratio of grid compression toward the wall (<1)
compressRatio_M=0.00;  //compression ratio in the middle layer
Nz=10;    //no of elements in z-dire (axial)
///////////////////////////////////////////////////

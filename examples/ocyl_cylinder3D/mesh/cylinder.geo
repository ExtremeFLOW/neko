...
Nxw  = 6;      Rxw  = 1.05;   // Progression ratio towards right  (elements clustered on right side of Nxw box if Rxw<0)
...
Nb   =  6;      Rb   = 0.8;    // Progression ratio towards center (elements clustered on the central part side of Nb box if Rb<0)
